        ...
        <div class="d-flex align-items-center flex-wrap gap-3">
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center me-3 vote-group">
              <span class="vote-count me-1 fw-bold text-dark">${formatVoteCount(req.votes.up)}</span>
              <button class="vote-btn upvote ${upClass}" onclick="handleVote(${req.id}, 1)">
                <i class="bi bi-hand-thumbs-up-fill"></i>
              </button>
            </div>
            <div class="d-flex align-items-center vote-group">
              <span class="vote-count me-1 fw-bold text-dark">${formatVoteCount(req.votes.down)}</span>
              <button class="vote-btn downvote ${downClass}" onclick="handleVote(${req.id}, -1)">
